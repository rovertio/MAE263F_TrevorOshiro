...
from HelperFunctions.RodGeom import computeReferenceTwist, computekappa, getRefTwist, getKappa
from HelperFunctions.ElasticFun import gradEs_hessEs, gradEb_hessEb, gradEt_hessEt, getFs, getFb, getFt
from HelperFunctions.PlottingFun import set_axes_equal, plotrod, plotrod_simple
...
if __name__ == "__main__":
    ...
    time_array, endZ = main(totalTime, dt)
